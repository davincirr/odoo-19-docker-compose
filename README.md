...
``` bash
curl -s https://raw.githubusercontent.com/davincirr/odoo-19-docker-compose/master/run.sh | bash -s produccion 10019 20019
```
and/or run the following to set up another Odoo instance @ `localhost:11019` (default master password: `control@U430corei5`):

``` bash
curl -s https://raw.githubusercontent.com/davincirr/odoo-19-docker-compose/master/run.sh | bash -s prueba 11019 21019
```
